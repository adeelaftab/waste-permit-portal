...
<style>
	.sw-theme-circles .sw-toolbar { display: none!important;}
	.nav-item  a { pointer-events: none!important;}
</style>
                ...
                <div id="step-3" class="">
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                        <hr>
						  <h6 class="wizard-title"><center>Your request has been Rejected</center></h6>
                        <hr>
                      </div>
						
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
						  <i class="dripicons-wrong approved rejected"></i>
                        <h6 class="wizard-title status-title"><a href="fdc_new.php" class="btn btn-primary">Request New Permit</a></h6>
                      </div>
