            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <h3 class="page-title"><i class="ti-write"></i> <span>New Permits Request</span></h3>
                        ...
                        <div class="card-body pt-0 pb-0 pl-0 pr-0">
                           <div class="">
                             <div class="progress" style="height: 150px;">
                                            <div class="progress-bar bg-success companyinfo activeprogress" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 25%"><i style="font-size: 40px" class="fa fa-info-circle"></i><br>Company Information</div>
                                            <div class="progress-bar bg-info waste-description deactiveprogress" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 25%"><i style="font-size: 40px" class="fa fa-prescription-bottle "></i><br>Waste Description</div>
                                            <div class="progress-bar bg-info purpose-sampling deactiveprogress" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 25%"><i style="font-size: 40px" class="fa fa-sitemap "></i><br>Purpose of Sampling</div>
                                            <div class="progress-bar bg-info disclaimer deactiveprogress" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 25%"><i style="font-size: 40px" class="fa fa-shopping-cart"></i><br>Disclaimer</div>
                                        </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                        <div class="col-8">
                            <div class="card m-b-20">
                                ...
                                <div class="card-body companyinfo-div">
                                    <div class="row">
                                ...
                                <div class="card-body wastedescription-div">
                                    <div class="row">
                                    <div class="form-group col-sm-6">
                                ...
                                <div class="card-body purposesample-div">
                                    <div class="row">
                                    <div class="form-group col-sm-12">
                                ...
                                <div class="card-body disclaimer-div">
                                    <div class="row">
                                    <div class="form-group col-sm-12">
                                        <label class="switch">
                                          <input type="checkbox">
