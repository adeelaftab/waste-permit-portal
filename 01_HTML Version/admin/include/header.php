...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="topbar">
            <!-- LOGO -->
            <div class="topbar-left"><a href="dashboard.php" class="logo"><span><img src="assets/images/logo3.png" alt="" height="50"> </span><i><img src="assets/images/logo-sm.png" alt="" height="22"></i></a></div>
                        ...
                        <form role="search" class="app-search">
                            <div class="btn-group m-b-10">
                                                ...
                                                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 33px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                    <a class="dropdown-item" href="#">Food Destruction Certificate</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" href="permits_new.php">Waste Permit</a>
                                                </div>
                                            </div>
                        </form>
                    </li>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li class="has-submenu">
                            ...
                            <ul class="submenu">
                                <li><a href="permits_management_new.php">New Permits</a></li>
                                <li><a href="permits_management_new.php">In progress Permits</a></li>
                                <li><a href="permits_management_new.php">Issues Permits</a></li>
                            </ul>
                        </li>
                        <li class="has-submenu">
                            <a href="javascript:void(0);" class="waves-effect">
                                <i class="mdi mdi-account-multiple"></i> <span>Manage Users <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span></span>
                            </a>
                            <ul class="submenu">
                                <li><a href="user_group.php">Users Groups</a></li>
                                <li><a href="user_management.php">List of Users</a></li>
                            </ul>
                        </li>
                        <li class="has-submenu">
                            <a href="javascript:void(0);" class="waves-effect">
                                <i class=" fas fa-building"></i> <span>Manage Companies <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span></span>
                            </a>
                            <ul class="submenu">
                        ...
                        <li class="has-submenu">
                            <a href="javascript:void(0);" class="waves-effect">
                                <i class="mdi mdi-currency-usd"></i> <span>Manage Billing <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span></span>
                            </a>
                            <ul class="submenu">
                        ...
                        <li><a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span>Manage Categories</span></a></li>
                        <li><a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-server"></i> <span>Manage Entites</span></a></li>
                        <li><a href="#"><i class="mdi mdi-settings"></i> <span>Edit Profile</span></a></li>
                        <li><a href="#"><i class="mdi mdi-lock-open-outline"></i> <span>Change Password</span></a></li>
                        <li><a href="#"><i class="mdi mdi-power"></i> <span>Logout</span></a></li>
                    </ul>
                </div>
                <!-- Sidebar -->
