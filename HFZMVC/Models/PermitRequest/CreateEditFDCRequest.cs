...
namespace HFZMVC.Models.PermitRequest
{
    public class CreateEditFDCRequest
    {
        ...
        public HttpPostedFileBase inspection_form { get; set; }
        public string total_package_weight_unit { get; set; }
