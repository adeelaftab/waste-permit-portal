                ...
                <div id="step-3" class="">
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                        <hr>
						  <h6 class="wizard-title"><center>Your request has been approved</center></h6>
                        <hr>
                      </div>
						
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
						  <i class="dripicons-checkmark approved"></i>
                        <h6 class="wizard-title status-title">Proceed to the payment</h6>
                      </div>
