<? include('include/header.php'); ?>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Frequently asked questions (FAQ) </h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active">You can find answers for the questions you have</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="" id="accordion">
        ...
        <div class="card ">
            <div class="card-header">
                <h4 class="card-header">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTen">Can I submit my own Bootstrap s or ?</a>
                </h4>
            </div>
            <div id="collapseTen" class="panel-collapse collapse">
                <div class="card-block">
                    A lot of the content of the site has been submitted by the community. Whether it is a commercial element// 
        ...
        <div class="card ">
            ...
            <div id="collapseEleven" class="panel-collapse collapse">
                <div class="card-block">
                    All prices for , s and other items, including each seller's or buyer's account balance are in <strong>USD</strong>
                </div>
            </div>
        </div>
            ...
            <div id="collapseThree" class="panel-collapse collapse">
                <div class="card-block">
                    ...
                    <ul>
                        ...
                        <li>Go to the <strong></strong> section and upload your </li>
            ...
            <div id="collapseSix" class="panel-collapse collapse">
                <div class="card-block">
                    ...
                    <ul>
                        ...
                        <li>Fast response/approval times. Many sites take weeks to process a  or . And if it gets rejected, there is another iteration. We have aliminated this, and made the process very fast. It only takes up to 72 hours for a / to get reviewed.</li>
        ...
        <div class="card ">
            <div class="card-header">
                <h4 class="card-header">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">I want to buy a  - what are the steps?</a>
                </h4>
            </div>
            <div id="collapseFour" class="panel-collapse collapse">
                <div class="card-block">
                    Buying a  on <strong>PrepBootstrap</strong> is really simple. Each  has a live preview. 
                    Once you have selected a  or , which is to your liking, you can quickly and securely pay via Paypal.
                    <br />
