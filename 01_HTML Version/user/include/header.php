            ...
            <nav class="navbar-custom">
                <ul class="navbar-right d-flex list-inline float-right mb-0">
                    ...
                    <li class="dropdown notification-list d-none d-sm-block">
                        <form role="search" class="app-search">
                            <div class="btn-group m-b-10">
                                                <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">New Payment &nbsp;<i class="fas fa-angle-down newrequest-arrow"></i></button>
                                                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 33px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                    <a class="dropdown-item" href="payment-manual.php">Payment Methods</a>
                                                   <!-- <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" href="payment-manual.php">Cheque</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" href="payment-manual.php">Money Transfer</a>-->
                                                </div>
                                            </div>
                        </form>
                    </li>
                    <li class="dropdown notification-list"><a class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false"><i class="ti-bell noti-icon"></i> <span class="badge badge-pill badge-danger noti-icon-badge">3</span></a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                            ...
                            <div class="slimscroll notification-item-list">
                                <!-- item-->
                                <a href="fdc_approved.php#step-3" class="dropdown-item notify-item active">
                                    <div class="notify-icon bg-success"><i class="mdi mdi-checkbox-marked-outline"></i></div>
                                    <p class="notify-details">Your order is approved</span></p>
                                </a>
                                <!-- item-->
                                <a href="fdc_rejected.php#step-3" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-warning"><i class="mdi mdi-block-helper"></i></div>
                                    <p class="notify-details">Your order is rejected</span></p>
                                </a>
                                <!-- item-->
                                <a href="fdc_required.php#step-3" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-info"><i class="mdi mdi-format-list-bulleted"></i></div>
                                    <p class="notify-details">More Information Required</span></p>
                                </a>
                                <!-- item-->
                            </div>
